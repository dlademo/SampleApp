...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="<c:url value="/resources/images/capledarship.jpg" />" alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="<c:url value="/resources/images/block1.jpg" />" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="item">
            <img class="third-slide" src="<c:url value="/resources/images/block2.jpg" />" alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="item">
            <img class="fourth-slide" src="<c:url value="/resources/images/network.jpg" />" alt="Fourth slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Cap Consultants Always vigilant to protect your network. </h1>
                </div>
            </div>
        </div>
        <div class="item">
            <img class="fifth-slide" src="<c:url value="/resources/images/block4.jpg" />" alt="Fifth slide">
            <div class="container">
                <div class="carousel-caption">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="<c:url value="/resources/images/testing2.jpg" />" alt="Generic placeholder image" width="140" height="140">
            <h2>Testing</h2>
            ...
            <p><a class="btn btn-default" href="testing.jsp" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="<c:url value="/resources/images/devops.png" />" alt="Generic placeholder image" width="140" height="140">
            <h2>DevOps</h2>
            ...
            <p><a class="btn btn-default" href="devops.jsp" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="<c:url value="/resources/images/development.jpg" />" alt="Generic placeholder image" width="140" height="140">
            ...
            <p><a class="btn btn-default" href="development.jsp" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
