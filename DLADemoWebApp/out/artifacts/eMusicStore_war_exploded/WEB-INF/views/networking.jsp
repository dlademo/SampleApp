...
<head>
    ...
    <title>Capgemini GS Network Security</title>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="images/networking1.jpg" alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="images/networking3.jpg" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
        ...
        <div class="item">
            <img class="second-slide" src="images/networking5.jpg" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
        ...
        <div class="item">
            <img class="third-slide" src="images/networking6.jpg" alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
