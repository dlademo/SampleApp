...
<head>
    ...
    <title>Capgemini GS DevOps Services</title>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="images/devops1.png" alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="images/devops2.jpg" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
        ...
        <div class="item">
            <img class="second-slide" src="images/devops3.png" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
        ...
        <div class="item">
            <img class="second-slide" src="images/devops4.png" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
        ...
        <div class="item">
            <img class="third-slide" src="images/devops5.png" alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
                    <!-- <h1>Meet With Capgemini GS Leadership Team</h1> --->
                </div>
